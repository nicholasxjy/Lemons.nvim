...
function M.get_highlights(c, opts)
    ...
    return {
        ...
        BlinkCmpKindDefault = { fg = c.light_pink },
        BlinkCmpKindFolder = { fg = c.orange },
        BlinkCmpKindFile = { fg = c.dark_blue },
        BlinkCmpKindText = { fg = c.darker_white },
        BlinkCmpKindMethod = { fg = c.light_blue },
        BlinkCmpKindFunction = { fg = c.light_blue },
